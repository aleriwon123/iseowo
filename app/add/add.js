...
const rules = yup.object().shape({
    business_name:yup.string("Business name must be a string").required("Business name is mandatory").min(6, "Business name must be at lease 6 characters"),
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="mb-3">
                            ...
                            <span className="text-xs text-red-400">{errors.category}</span>: null}
                        </div>
                        <div className="mb-3">
                            <TextField
                            select
                            ...
                            <span className="text-xs text-red-400">{errors.sub_category}</span>: null}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div className="mb-3">
                            ...
                            <span className="text-xs text-red-400">{errors.lga}</span>: null}
                        </div>
                    </div>
                    ...
                    <div className="mb-3">
                        ...
                        <span className="text-xs text-red-400">{errors.business_description}</span>: null}
                    </div>
                    <div className="mb-3">
                        <TextField
                        type="text"
                        ...
                        <span className="text-xs text-red-400">{errors.website}</span>: null}
                    </div>
                    <button type="submit" className="bg-lime-600 text-white px-3 py-2 uppercase rounded-sm">Submit Business</button>
                </form>
                { startProgress ?
