        ...
        <div className="flex flex-col gap-2 ">
            <div className="flex gap-2">
                ...
                <Link href="#" className="flex flex-col">
                    ...
                    <span className="text-xs text-gray-500">Abaji, Abuja</span>
                </Link>

            </div>

            <p>A variety of reported recipes and experimental recreations have been published. The secrecy around the formula has been used by Coca-Cola as a marketing aid because only a handful of anonymous employees know the formula.</p>
